...
const UserProfile = () => {
  ...
  const [showFollower , setshowFollower] = useState(state ? !state.following.includes(userid) : true);
  console.log(userid);
      ...
      <div className="profile-page">
        ...
        <div className="details">
          ...
          <div className="follow">
                ...
                <h6
                  style={{ color: "blue", opacity: "2px", cursor: "pointer" }}
                >
          ...
          >
            Follow
              ...
              <i className="material-icons " onClick={()=>followUser()}>person_add</i>  </button>)
            :
            (<button
            className="btn waves-effect waves-light #64b5f6 blue darken-2"
            type="submit"
